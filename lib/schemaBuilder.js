import TypeMap from '../schemaTypes.js'
...
function runMiddleware(modelName, key, value, type, options) {
  if (options.hasOwnProperty('middlewares') && options.middlewares[modelName]) {
    const middlewares = options.middlewares[modelName] || []
